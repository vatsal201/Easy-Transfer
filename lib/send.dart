...
class Send extends StatefulWidget {
  ...
  @override
  _SendState createState() => _SendState(userName2: userName1);
}
...
class Body extends StatefulWidget {
  ...
  @override
  _BodyState createState() => _BodyState(userName: userName3);
}
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                                ...
                                image: DecorationImage(
                                    image: AssetImage('assets/sendArrow.jpeg')),
                                boxShadow: [
                                  BoxShadow(
                                    color: Colors.black,
                          ...
                          builder: (BuildContext context) {
                            return Theme(
                                ...
                                child: CupertinoAlertDialog(
                                  ...
                                  content: Text(
                                      'This app needs permission. You can grant them in app settings.'),
                                  actions: [
                    ...
                    ? GestureDetector(
                        onTap: () async {
                          ...
                          for (int i = 0; i < files.length; i++) {
                            ...
                            try {
                              aesFilepath =
                                  await crypt.encryptFile(encFilepath);
                              print(
                            ...
                            int payloadId = await Nearby()
                                .sendFilePayload(cId, aesFilepath);
                ...
                pressed
                    ? GestureDetector(
                        onTap: () async {
                          ...
                          int payloadId =
                              await Nearby().sendFilePayload(cId, aesFilepath);
                          showSnackbar("Sending file");
                          Nearby().sendBytesPayload(
                              cId,
                              Uint8List.fromList(
                ...
                ? GestureDetector(
                    onTap: () async {
                      ...
                      for (int i = 0; i < file.length; i++) {
                        ...
                        ext = ext.substring(
                            ext.indexOf(".") + 1, ext.lastIndexOf("."));
                        crypt.setOverwriteMode(AesCryptOwMode.on);
                        try {
                          decFilepath = directory;
                          decFilepath = await crypt.decryptFile(
                              file[i].path, '$decFilepath/$s.$ext');
                          file[i].delete();
                        } on AesCryptException catch (e) {
